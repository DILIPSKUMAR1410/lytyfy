...
class FieldRepresentative
{
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\OneToMany(targetEntity="Deviab\DatabaseBundle\Entity\DeviabBorrowerTransaction", mappedBy="fieldRepresentative")
     */
    private $fromBorrowerCollections;
    ...
    public function __construct()
    {
        ...
        $this->fromBorrowerCollections = new \Doctrine\Common\Collections\ArrayCollection();
    }
